...
namespace OurTests
{
    public class InsertTests
    {
        ...
        {
            string query = "INSERT INTO Personas VALUES ('Dato1','Dato2','Dato3')";
        ...
        public void TestInsertCommasAndSpaces()
        {
            ...
            string query2 = "INSERT INTO TestTable VALUES ('a','b','c')";
            Insert result2 = MiniSQLParser.Parse(query2) as Insert;
            Assert.NotNull(result2);

            string query3 = "INSERT INTO TestTable VALUES ('12','3.45','Text')";
            ...
            string query5 = "INSERT INTO TestTable VALUES ('a' ,'b')";
            Insert result5 = MiniSQLParser.Parse(query5) as Insert;
            Assert.Null(result5);

            string query6 = "INSERT INTO TestTable VALUES ('a',    'b')";
            Insert result6 = MiniSQLParser.Parse(query6) as Insert;
            Assert.Null(result6);

            string query7 = "INSERT INTO TestTable VALUES ('a', 'b', 'c' )";
